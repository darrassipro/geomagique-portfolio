...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-secondary clip-path-diagonal-inverted">
      <div className="container px-4 md:px-6 pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16">
          ...
          <div className="animate-reveal">
            <div className="bg-background rounded-2xl p-8 shadow-sm neo-glass h-full">
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide transition-colors bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                <a
                  ...
                  className="flex items-start p-5 rounded-xl transition-all hover:bg-background hover:shadow-sm"
                >
