...
const SkillIcon = ({ Icon, label }: { Icon: any; label: string }) => (
  <div className="flex flex-col items-center group">
    <div className="w-14 h-14 rounded-full flex items-center justify-center bg-primary/5 mb-3 
      ...
      group-hover:shadow-lg group-hover:shadow-primary/10 backdrop-blur-sm relative overflow-hidden">
...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="relative min-h-screen flex items-center pb-20 pt-28 overflow-hidden">
      <Canvas className="opacity-70" />
      
      {/* Gradient overlays */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b 
          from-background/0 via-background/10 to-background z-[1]"></div>
        <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-radial 
          from-primary/5 to-transparent z-[1] blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-1/3 h-1/2 bg-gradient-radial 
          from-primary/5 to-transparent z-[1] blur-3xl"></div>
      </div>
        ...
        <div className="max-w-4xl">
          ...
          <div className="inline-block animate-fade-in opacity-0" 
            ...
            <div className="glass-badge px-4 py-2 rounded-full mb-6 inline-flex items-center 
              ...
              hover:border-white/30 transition-all duration-300 shadow-lg shadow-primary/5">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-tight 
            md:leading-tight lg:leading-tight mb-2 opacity-0 animate-fade-in" 
            style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            <span className="bg-clip-text text-transparent bg-gradient-to-r 
              from-foreground via-foreground/90 to-foreground/60 animate-gradient">
              YOUNES DARRASSI
            </span>
          </h1>
          ...
          <div className="relative">
            <h2 className="text-2xl md:text-3xl text-muted-foreground mb-6 opacity-0 
              ...
              <div className="h-px flex-grow max-w-[120px] bg-gradient-to-r 
                from-primary/50 to-transparent"></div>
            </h2>
          </div>
          
          {/* Description */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-8 opacity-0 
          ...
          <div className="flex flex-wrap gap-4 opacity-0 animate-fade-in" 
            ...
            <a href="#projects" className="group relative inline-flex items-center justify-center 
              h-12 px-8 font-medium tracking-wide transition-all duration-300 bg-primary 
              text-primary-foreground hover:bg-primary/90 rounded-full shadow-lg 
              shadow-primary/20 hover:shadow-primary/30">
              <span className="absolute inset-0 w-0 bg-gradient-to-r from-primary/80 
                to-primary/40 transition-all duration-500 ease-out group-hover:w-full 
                rounded-full overflow-hidden"></span>
            ...
            <a href="#contact" className="group relative inline-flex items-center justify-center 
              h-12 px-8 font-medium tracking-wide transition-all duration-300 bg-secondary 
              hover:bg-secondary/80 rounded-full backdrop-blur-sm shadow-lg 
              shadow-secondary/10 hover:shadow-secondary/20">
              <span className="absolute inset-0 w-0 bg-white/5 transition-all duration-500 
                ease-out group-hover:w-full rounded-full overflow-hidden"></span>
              <span className="relative z-10">Me Contacter</span>
            </a>
          </div>
          
          {/* Skills Grid */}
          <div className="mt-16 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-4 
            max-w-3xl opacity-0 animate-fade-in" 
      ...
      {/* Bottom gradient */}
      <div className="absolute bottom-0 left-0 w-full h-48 bg-gradient-to-t 
