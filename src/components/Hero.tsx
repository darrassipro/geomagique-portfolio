...
const Hero: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Main content grid for responsive layout */}
      <div className="relative z-10 container mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-8">
        ...
        <div className="max-w-2xl text-center md:text-left">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-2 opacity-0 animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
          ...
          <div className="relative inline-block md:block">
            <h2 className="text-2xl md:text-3xl text-muted-foreground mb-6 opacity-0 animate-fade-in flex items-center justify-center md:justify-start" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
              <span className="mr-3">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto md:mx-0 mb-8 opacity-0 animate-fade-in leading-relaxed" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 opacity-0 animate-fade-in" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
            <a href="#projects" className="group relative inline-flex items-center justify-center h-12 px-8 font-medium tracking-wide transition-all duration-300 bg-primary text-primary-foreground hover:bg-primary/90 rounded-full shadow-lg shadow-primary/20 hover:shadow-primary/30">
              <span className="relative z-10 flex items-center">
                Voir Projets
                <ArrowRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
              </span>
            </a>
            <a href="#contact" className="group relative inline-flex items-center justify-center h-12 px-8 font-medium tracking-wide transition-all duration-300 bg-secondary hover:bg-secondary/80 rounded-full shadow-lg shadow-secondary/10 hover:shadow-secondary/20">
        ...
        <div className="flex justify-center items-center opacity-0 animate-fade-in" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
          <Canvas />
        </div>
      </div>
    </section>
